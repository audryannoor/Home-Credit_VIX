...
EXT_SOURCE_1 = st.slider('Input External Source 1, Optional',0.0,1.0)
EXT_SOURCE_2 = st.slider('Input external source 2, Optional',0.0,1.0)
EXT_SOURCE_3 = st.slider('Input external source 3, Optional',0.0,1.0)
